...
@section('isihalaman')
    <h3><center>Daftar Buku Perpustakaan Stiki</center></h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formbukuedit" id="formbukuedit" action="/buku/edit/{{ $bk->id_buku}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="kode_buku" name="kode_buku1" placeholder="Masukan Kode Buku" value="{{ $bk->kode_buku}}">
                                                </div>
                                            </div>
